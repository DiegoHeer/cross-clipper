/**
 * Mobile-side persisted feed.
 *
 * Port of the extension's FeedStore (extension spec §6, plan A2).
 * Persists BOTH `cc.items` AND `cc.itemTombstones` — tombstone-wins permanently.
 * Capped at 1000 items newest-first (ULID descending).
